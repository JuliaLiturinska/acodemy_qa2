...
Создать класс Animal и описать свойства, которые присущи каждому животному.
 ...
 • Научить программу кормить животного (представьте у животного есть 4 заряда энергии на весь день,
 выполняя какие-то занятия он тратит энергию, покормив животного он получает все 4 заряда энергии)
 ...
 • Поставить проверку на то, что животное не может выполнять какие-то команды
 если у нее 0 заряда батареи, тогда программа должна сказть что нужно отправить животное покушать!
 */